...
-- Update the unique constraint to include emoji (users can have different emoji reactions on same post)
DROP INDEX IF EXISTS likes_user_id_post_id_key;
CREATE UNIQUE INDEX likes_user_post_emoji_unique ON public.likes(user_id, post_id, emoji);
