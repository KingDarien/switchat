...
DROP POLICY IF EXISTS "Community mappings are viewable by everyone" ON public.user_communities;
DROP POLICY IF EXISTS "Users can view their own communities" ON public.user_communities;
